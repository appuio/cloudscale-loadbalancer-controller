module github.com/appuio/cloudscale-loadbalancer-controller
...
require (
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20250905084728-51bd4f4aca7d // indirect
